...
public class MatchBalancingHelpersTest
{
    ...
    private static readonly CrpgUser Sam = new() { Character = new CrpgCharacter { Name = "Sam", Id = 3, Rating = new CrpgCharacterRating { Value = 1500 } }, ClanMembership = new CrpgClanMember { ClanId = 1 } };
    ...
    private readonly GameMatch _game1 = new()
    {
    ...
    private readonly GameMatch _game2 = new()
    {
        TeamA = new List<CrpgUser>()
        {
            Arwen,
    ...
    public void ConvertingToClanGroupsThenToUserListShouldDoNothing()
    {
        ...
        userList.AddRange(_game1.Waiting);
        userList.AddRange(_game1.TeamA);
        userList.AddRange(_game1.TeamB);
    ...
    public void RegroupClansShouldNotLoseOrAddCharacters()
    {
        ...
        allUsersFromUnbalancedGame.AddRange(_game2.TeamA);
        allUsersFromUnbalancedGame.AddRange(_game2.TeamB);
