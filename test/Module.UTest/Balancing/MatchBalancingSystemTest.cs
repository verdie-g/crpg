...
public class MatchBalancingSystemTest
{
    ...
    private static readonly CrpgUser Hudax06 = new() { Character = new CrpgCharacter{ Name = "", Id = 5036, Rating = new CrpgCharacterRating { Value = 1900 }}, ClanMembership = new CrpgClanMember { ClanId = 10} };
    private static readonly CrpgUser Hudax07 = new() { Character = new CrpgCharacter{ Name = "", Id = 5037, Rating = new CrpgCharacterRating { Value = 8000 }}, ClanMembership = new CrpgClanMember { ClanId = 10} };
    private static readonly CrpgUser Hudax08 = new() { Character = new CrpgCharacter{ Name = "", Id = 5038, Rating = new CrpgCharacterRating { Value = 1300 }}, ClanMembership = new CrpgClanMember { ClanId = 10} };
    private static readonly CrpgUser Hudax09 = new() { Character = new CrpgCharacter{ Name = "", Id = 5039, Rating = new CrpgCharacterRating { Value = 1400 }}, ClanMembership = new CrpgClanMember { ClanId = 10} };
    private static readonly CrpgUser Hudax10 = new() { Character = new CrpgCharacter{ Name = "", Id = 5040, Rating = new CrpgCharacterRating { Value = 700 }}, ClanMembership = new CrpgClanMember { ClanId = 10} };
