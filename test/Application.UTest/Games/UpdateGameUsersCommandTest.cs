...
public class UpdateGameUsersCommandTest : TestBase
{
    ...
    {
        UserItem userItem0 = new() { BrokenState = 0, Item = new Item { Id = "0" } };
        UserItem userItem1 = new() { BrokenState = 0, Item = new Item { Id = "1" } };
        UserItem userItem2 = new() { BrokenState = 0, Item = new Item { Id = "2" } };
        UserItem userItem3 = new() { BrokenState = 0, Item = new Item { Id = "3" } };
        UserItem userItem4 = new() { BrokenState = 0, Item = new Item { Id = "4" } };
        ...
        // Check the user item BrokenStates were set to -1.
        ...
        {
            Assert.That(userItem.BrokenState, Is.EqualTo(-1));
        }
    }
}
