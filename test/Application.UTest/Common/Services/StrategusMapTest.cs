...
public class StrategusMapTest
{
    ...
    [TestCase(Region.Eu, Region.Oce, 2004, 7)]
    [TestCase(Region.Na, Region.Eu, 1996, 7)]
    [TestCase(Region.Na, Region.Na, 4, 7)]
    [TestCase(Region.Na, Region.As, 3996, 7)]
    [TestCase(Region.Na, Region.Oce, 3996, 7)]
    [TestCase(Region.As, Region.Eu, -1996, 7)]
    [TestCase(Region.As, Region.Na, 3996, 7)]
    [TestCase(Region.As, Region.As, 4, 7)]
    [TestCase(Region.As, Region.Oce, 4, 7)]
    [TestCase(Region.Oce, Region.Eu, -1996, 7)]
    [TestCase(Region.Oce, Region.Na, 3996, 7)]
    [TestCase(Region.Oce, Region.As, 4, 7)]
    [TestCase(Region.Oce, Region.Oce, 4, 7)]
