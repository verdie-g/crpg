...
internal class ItemExporter : IDataExporter
{
    ...
    private static readonly Dictionary<string, (string aimSpeed, string reloadSpeed, string damage, string missileSpeed)> BowStats = new()
    {
        ...
        ["crpg_composite_steppe_bow"] = ("106", "101", "13", "88"),
        ["crpg_steppe_heavy_bow"] = ("102", "100", "13", "85"),
        ["crpg_composite_bow"] = ("104", "98", "12", "83"),
        ["crpg_nordic_shortbow"] = ("100", "99", "11", "84"),
        ["crpg_hunting_bow"] = ("102", "97", "11", "83"),
        ["crpg_mountain_hunting_bow"] = ("98", "95", "10", "84"),
        ...
        ["crpg_nomad_bow"] = ("92", "88", "14", "91"),
        ["crpg_tribal_bow"] = ("90", "88", "14", "92"),
        ["crpg_lowland_longbow"] = ("91", "89", "13", "92"),
        ["crpg_glen_ranger_bow"] = ("89", "88", "13", "91"),
        ["crpg_highland_ranger_bow"] = ("87", "86", "13", "92"),
        ["crpg_training_longbow"] = ("94", "89", "6", "94"),
    };
