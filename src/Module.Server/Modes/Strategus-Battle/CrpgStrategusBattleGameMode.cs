...
internal class CrpgStrategusBattleGameMode : MissionBasedMultiplayerGameMode
{
    private const string BattleGameName = "cRPGStrategusBattle";
    ...
    public CrpgStrategusBattleGameMode(CrpgConstants constants, bool isSkirmish)
        : base(BattleGameName)
    {
            ...
            _ =>
                new MissionBehavior[]
                {
...
#if CRPG_SERVER
                    roundController,
                    new CrpgStrategusBattleServer(StrategusBattleClient),
                    ...
                    new SpawnComponent(new BattleSpawnFrameBehavior(),
                        new CrpgStrategusBattleSpawningBehavior(_constants, roundController)),
